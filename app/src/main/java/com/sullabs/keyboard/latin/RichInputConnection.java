...
import com.sullabs.keyboard.compat.InputConnectionCompatUtils;
import com.sullabs.keyboard.latin.common.Constants;
import com.sullabs.keyboard.latin.common.UnicodeSurrogate;
import com.sullabs.keyboard.latin.common.StringUtils;
import com.sullabs.keyboard.latin.inputlogic.PrivateCommandPerformer;
import com.sullabs.keyboard.latin.settings.SpacingAndPunctuations;
import com.sullabs.keyboard.latin.utils.CapsModeUtils;
import com.sullabs.keyboard.latin.utils.DebugLogUtils;
import com.sullabs.keyboard.latin.utils.NgramContextUtils;
import com.sullabs.keyboard.latin.utils.ScriptUtils;
import com.sullabs.keyboard.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.sullabs.keyboard.latin.common.Constants.UnicodeSurrogate
