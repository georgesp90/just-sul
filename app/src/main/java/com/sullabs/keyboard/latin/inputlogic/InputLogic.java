...
package com.sullabs.keyboard.latin.inputlogic;
...
import com.sullabs.keyboard.compat.SuggestionSpanUtils;
...
import com.sullabs.keyboard.latin.Dictionary;
import com.sullabs.keyboard.latin.DictionaryFacilitator;
import com.sullabs.keyboard.latin.LastComposedWord;
import com.sullabs.keyboard.latin.LatinIME;
import com.sullabs.keyboard.latin.NgramContext;
import com.sullabs.keyboard.latin.RichInputConnection;
import com.sullabs.keyboard.latin.Suggest;
import com.sullabs.keyboard.latin.Suggest.OnGetSuggestedWordsCallback;
import com.sullabs.keyboard.latin.SuggestedWords;
import com.sullabs.keyboard.latin.SuggestedWords.SuggestedWordInfo;
import com.sullabs.keyboard.latin.WordComposer;
import com.sullabs.keyboard.latin.common.Constants;
import com.sullabs.keyboard.latin.common.InputPointers;
import com.sullabs.keyboard.latin.common.StringUtils;
import com.sullabs.keyboard.latin.define.DebugFlags;
import com.sullabs.keyboard.latin.settings.SettingsValues;
import com.sullabs.keyboard.latin.settings.SettingsValuesForSuggestion;
import com.sullabs.keyboard.latin.settings.SpacingAndPunctuations;
import com.sullabs.keyboard.latin.suggestions.SuggestionStripViewAccessor;
import com.sullabs.keyboard.latin.utils.AsyncResultHolder;
import com.sullabs.keyboard.latin.utils.InputTypeUtils;
import com.sullabs.keyboard.latin.utils.RecapitalizeStatus;
import com.sullabs.keyboard.latin.utils.StatsUtils;
import com.sullabs.keyboard.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link com.sullabs.keyboard.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link com.sullabs.keyboard.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link com.sullabs.keyboard.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, com.sullabs.keyboard.latin.SuggestedWords)}.
